...
export default function Navbar() {
  ...
  return (
    <header className="w-full bg-[#111714] ">
      {/* bg-[#111714] */}
      ...
      <div className="max-w-screen-xl mx-auto flex flex-col px-4 md:px-10 py-5">
        <div className="flex flex-wrap justify-between gap-3 p-0 md:p-4">
          <p className="text-white text-2xl md:text-[32px] font-bold leading-tight min-w-60 md:min-w-72">
          ...
          <div className="flex border-b border-[#3d5245] px-2 md:px-4 gap-4 md:gap-8 overflow-x-auto">
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  <p className={`text-sm font-bold leading-normal tracking-[0.015em] ${isActive ? "text-white" : "text-gray-500"}`}>
                    {/* text-[#9eb7a8] */}
                    {tab.label}
                  </p>
                </Link>
